/// Integration tests for dart-pubdev-explorer against the live pub.dev API.
///
...
/// Wraps a spawned `dart_pubdev_mcp` process with typed send/receive helpers.
///
